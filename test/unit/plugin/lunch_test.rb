...
class Robut::Plugin::LunchTest < Test::Unit::TestCase
  ...
  def test_handle_new_lunch_place
    ...
    assert_equal ["Ok, I'll add \"Green Leaf\" to the the list of lunch places"], @plugin.replies
  ...
  def test_handle_remove_lunch_place
    ...
    assert_equal ["I removed \"Pho\" from the list of lunch places"], @plugin.replies
